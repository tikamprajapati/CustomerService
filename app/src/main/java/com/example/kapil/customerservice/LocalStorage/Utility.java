package com.example.kapil.customerservice.LocalStorage;
...
/*
	public static void sweet_alert_false(Context context, String msg) { */
/* final SweetAlertDialog pDialog;  pDialog = new SweetAlertDialog(context, SweetAlertDialog.ERROR_TYPE);  pDialog.setTitleText("Info");  pDialog.setContentText(msg);  pDialog.setCancelable(true);  pDialog.show();*//*
  */
/*new Handler().postDelayed(new Runnable() {   //start the progress dialog   @Override   public void run() {    pDialog.dismiss();   }  }, 4000);*//*
		...
		pDialog.setCustomImage(R.mipmap.iconinfo);
		pDialog.show();
